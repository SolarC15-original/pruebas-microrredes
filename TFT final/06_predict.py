"""
06_predict.py — Predicción TFT con datos frescos de MongoDB + Open-Meteo
...
def plot_predictions(predictions, output_len):
    ...
    fig.update_layout(
        ...
        title='Predicción TFT — Próximas 24 horas (288 intervalos de 15min)',
        showlegend=True,
...
def main():
    print("="*70)
    print("PASO 6: Predicción TFT — Datos Frescos MongoDB + Open-Meteo")
    print("="*70)

    print("\n[1] Cargando modelo y parámetros...")
    model, params = load_tft_model()
    seq_len = params['seq_len']
    output_len = params['output_len']
    print(f"    seq_len={seq_len}, output_len={output_len}, d_model={params['d_model']}")
    ...
    print("\n" + "-"*50)
    print("PREDICCIONES TFT — Próximas 24 horas")
    print("-"*50)
